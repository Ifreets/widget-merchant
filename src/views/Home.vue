<template>
    <div class="w-full h-full flex justify-center items-center bg-slate-300">
        <div
            class="w-screen h-screen sm:w-[395px] sm:h-[300px] bg-white text-sm"
        >
            <div
            ...
            >
                ...
                <div class="py-1 px-3 bg-slate-100 rounded-lg">
                    ...
                    >
                        <p
                            class="w-1/2 rounded py-1 cursor-pointer select-none"
                            :class="
                                appStore.tab === 'USER'
                ...
                <div v-if="WIDGET.is_admin" class="flex justify-end">
                    <p
                        class="bg-slate-200 text-slate-700 py-1 px-2 rounded-md cursor-pointer text-xs font-medium select-none"
